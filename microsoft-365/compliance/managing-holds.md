...
> [!NOTE]
> Custodial Holds cannot be turned ON or OFF from the Security & Compliance center GUI. Aministrator needs to use Powershell to make this change. For more information, See [Set-CaseHoldPolicy](https://docs.microsoft.com/powershell/module/exchange/set-caseholdpolicy?view=exchange-ps)
